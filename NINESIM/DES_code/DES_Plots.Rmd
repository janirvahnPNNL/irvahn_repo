...
```{r arrival queue lengths by time,echo=FALSE,fig.cap='yeesher'}
p0
```

```{r queue lengths by time,echo=FALSE,fig.cap='yeesh'}
library(grid)
library(gridExtra)
grid.arrange(p1,p2,p3,p4,ncol=2)
```

```{r queue length summary,echo=FALSE,fig.cap='yoyoyo'}
